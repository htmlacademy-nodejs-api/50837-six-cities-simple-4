...
import DBClientService from './core/database-client/db-client.service.js';
...
async function bootstrap() {
  ...
  container.bind<DatabaseClientInterface>(AppComponent.DatabaseClientInterface).to(DBClientService).inSingletonScope();
